...
def federated_learning(args, device, train_dataset, test_dataset, user_groups, logger, malicious_clients, manipulation_factor):
    local_updates = {}
...
if __name__ == '__main__':
    ...
    accuracy_no_attack, loss_no_attack = federated_learning(args, device, train_dataset, test_dataset, user_groups, logger, malicious_clients=[], manipulation_factor=1.0)
    ...
    accuracy_with_attack, loss_with_attack = federated_learning(args, device, train_dataset, test_dataset, user_groups, logger, malicious_clients=malicious_clients, manipulation_factor=manipulation_factor)
    ...
    plt.plot(range(len(accuracy_no_attack)), accuracy_no_attack, color='g', label='No DoS Attack')
    plt.plot(range(len(accuracy_with_attack)), accuracy_with_attack, color='r', label='With DoS Attack')
    ...
    plt.plot(range(len(loss_no_attack)), loss_no_attack, color='g', label='No DoS Attack')
    plt.plot(range(len(loss_with_attack)), loss_with_attack, color='r', label='With DoS Attack')
